...
class YatzyTest extends TestCase
{
    ...
    {
        self::assertSame(1, (new Yatzy(1, 2, 3, 4, 5))->scoreSpecificValue(1));
        self::assertSame(2, (new Yatzy(1, 2, 1, 4, 5))->scoreSpecificValue(1));
        self::assertSame(0, (new Yatzy(6, 2, 2, 4, 5))->scoreSpecificValue(1));
        self::assertSame(4, (new Yatzy(1, 2, 1, 1, 1))->scoreSpecificValue(1));
    }

    public function test2s(): void
    {
        self::assertSame(4, (new Yatzy(1, 2, 3, 2, 6))->scoreSpecificValue(2));
        self::assertSame(10, (new Yatzy(2, 2, 2, 2, 2))->scoreSpecificValue(2));
    }

    public function testThrees(): void
    {
        self::assertSame(6, (new Yatzy(1, 2, 3, 2, 3))->scoreSpecificValue(3));
        self::assertSame(12, (new Yatzy(2, 3, 3, 3, 3))->scoreSpecificValue(3));
    }

    public function testFours(): void
    {
        self::assertSame(12, (new Yatzy(4, 4, 4, 5, 5))->scoreSpecificValue(4));
        self::assertSame(8, (new Yatzy(4, 4, 5, 5, 5))->scoreSpecificValue(4));
        self::assertSame(4, (new Yatzy(4, 5, 5, 5, 5))->scoreSpecificValue(4));
    }

    public function testFives(): void
    {
        self::assertSame(10, (new Yatzy(4, 4, 4, 5, 5))->scoreSpecificValue(5));
        self::assertSame(15, (new Yatzy(4, 4, 5, 5, 5))->scoreSpecificValue(5));
        self::assertSame(20, (new Yatzy(4, 5, 5, 5, 5))->scoreSpecificValue(5));
    }

    public function testSixes(): void
    {
        self::assertSame(0, (new Yatzy(4, 4, 4, 5, 5))->scoreSpecificValue(6));
        self::assertSame(6, (new Yatzy(4, 4, 6, 5, 5))->scoreSpecificValue(6));
        self::assertSame(18, (new Yatzy(6, 5, 6, 6, 5))->scoreSpecificValue(6));
    }
